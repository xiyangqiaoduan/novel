 ...
 *
 * @author yangcb
 * @create 2017-07-14 11:24
 **/
public class TaoToTaoConstants {


    /**
     * 易读配置文件
     */
    public static PropertiesConfiguration taoToTaoConf;
    /**
     * 伪静态配置文件
     */
     ...
     * 前缀
     */
    private static final String PREFIX = "taototao.Novel.";
