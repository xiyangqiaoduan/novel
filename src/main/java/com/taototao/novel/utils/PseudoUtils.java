...
import com.taototao.novel.bean.ReplaceKeywordsBean;
import com.taototao.novel.constant.PseudoConstants;
...
public class PseudoUtils {
    ...
    public static String topAppend(String content) {
        String topAppend = TaoToTaoConstants.pseudoConf.getString("top_append_text", "");

        String baseUrl = TaoToTaoConstants.taoToTaoConf.getString("uri");
     ...
     * @return 添加信息后的章节内容
     */
    public static String bottomAppend(Chapter chapter, String content) {

        // TODO URL变成动态的
        String bottomAppend = TaoToTaoConstants.pseudoConf.getString("bottom_append_text", "");
    ...
    public static String fetchKeywords(String content) {
        ...
        int keywordsCount = TaoToTaoConstants.pseudoConf.getInt("keywords_count", 0);
        ...
        String keywordsPosition = TaoToTaoConstants.pseudoConf.getString("keywords_position", "bottom");
